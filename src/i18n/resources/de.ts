const de = {
  ...
  dialogs: {
    application: {
      ...
      description: "Fülle die Bewerbungsdaten aus und speichere die Änderungen.",
    ...
    confirmDelete: {
      ...
      description: "Möchtest du {{label}} wirklich löschen? Diese Aktion kann nicht rückgängig gemacht werden.",
    },
  },
};
